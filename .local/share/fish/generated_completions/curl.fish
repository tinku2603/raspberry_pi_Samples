...
complete -c curl -l fail-early --description 'Fail and exit on first detected error.'
...
complete -c curl -s k -l insecure --description '(TLS) This option explicitly allows curl to perform "insecure" SSL connection…'
...
complete -c curl -l preproxy --description 'Use the specified proxy before connecting to the ordinary proxy.'
