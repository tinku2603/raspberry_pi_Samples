...
complete -c cms -o data_create --description 'Create a \\s-1CMS \\s0Data type.'
complete -c cms -o data_out --description 'Data type and output the content.'
complete -c cms -o digest_create --description 'Create a \\s-1CMS \\s0DigestedData type.'
complete -c cms -o digest_verify --description 'Verify a \\s-1CMS \\s0DigestedData type and output the content.'
complete -c cms -o compress --description 'Create a \\s-1CMS \\s0CompressedData type.'
complete -c cms -o uncompress --description 'Uncompress a \\s-1CMS \\s0CompressedData type and output the content.'
complete -c cms -o EncryptedData_encrypt --description 'Encrypt content using supplied symmetric key and algorithm using a \\s-1CMS \\s…'
